...
export const useWebSocket = (url: string): UseWebSocketReturn => {
  ...
  const [testStartData, setTestStartData] = useState<TestStartData | null>(null)
  const [testProgress, setTestProgress] = useState<TestProgressData | null>(null)
  const [testResults, setTestResults] = useState<TestResultData[]>([])
  const [testCompleteData, setTestCompleteData] = useState<TestCompleteData | null>(null)
  const [testCancelledData, setTestCancelledData] = useState<TestCancelledData | null>(null)
